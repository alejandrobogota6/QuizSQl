...
<html>
    ...
    <center>
        ...
        <table >
            <tr>
                <td> <a href="UnidadAbstractaInformacion.jsp"> <input style="background-color: #33ffff" class="submit" type="submit" name="venta_registrada" value="Crear Unidad Abstracta" /> </td>
